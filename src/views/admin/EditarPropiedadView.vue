...
<template>
        ...
        <v-card max-width="800" flat class="mx-auto my-10">
                ...
                <v-form class="mt-10">
                        ...
                        <v-file-input v-model="imagen.value.value" :error-messages="imagen.errorMessage.value"
                                accept="image/jpeg" prepend-icon="mdi-camera" label="Fotografía" class="mb-5"
                                @change="uploadImage"></v-file-input>

                        <div class="my-5">
                                <p class="font-weight-bold">Imagen Actual:</p>
                                <img v-if="image" class="w-50" :src="propiedad?.imagen" alt="Imagen Propiedad" />

                                <img v-else class="w-50" :src="propiedad?.imagen" alt="Imagen Propiedad" />
